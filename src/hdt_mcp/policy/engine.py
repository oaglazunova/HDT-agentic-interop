...
from hdt_common.errors import REDACT_TOKEN, typed_error


CONFIG_DIR = Path(os.getenv("HDT_CONFIG_DIR", str(Path.cwd() / "config")))
_POLICY_PATH = Path(os.getenv("HDT_POLICY_PATH", str(CONFIG_DIR / "policy.json")))
